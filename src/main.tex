...
% User Manual Mockups
    \include{chapters/02-user-manual-mockups/user-manual-mockups}

% Design
    \include{chapters/03-design/design}

% Data modelling and structure
    \include{chapters/04-data-modelling-and-structure/data-modelling-and-structure}

% Implementation
    \include{chapters/05-implementation/implementation}

% Relevant operations
    \include{chapters/06-relevant-operations/relevant-operations}

% Design choices
    \include{chapters/07-design-choices/design-choices}

% Future works
    \include{chapters/08-future-works/future-works}
